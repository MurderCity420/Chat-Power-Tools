...
Click the button below. Tampermonkey will open a confirmation page.
...
| The shield icon in the chat top bar |
|:---:|
| ![Shield icon location](../screenshots/shield-icon.png) |

---

**Next:** [Getting Started →](getting-started.md) · [Updating & Uninstalling →](updating-and-uninstalling.md)
