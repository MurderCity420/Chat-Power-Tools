...
- **Force Resolution + Clean Audio** — overrides your webcam's capture request with a chosen resolution (**320×240** up to **1920×1080**) and disables the browser's voice-processing DSP (echo cancellation / noise suppression / auto gain) so music or line-in audio comes through clean instead of being treated like a phone call. Takes effect on your next broadcast start — no reload needed.
