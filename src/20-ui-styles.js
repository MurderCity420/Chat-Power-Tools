    ...
    function injectStyles() {
        const css = `
            ...
            /* Cam-template dropdown — mirrors the gear so it flows inline with the
               site's nav icons (no float) and sits left of the shield/holiday.
               Anchored in the DOM after the holiday-or-gear icon, then nudged a
               further 140px left with a relative offset (works in any flow, and
               the base position already adapts to whether the holiday is shown). */
            #nav_chatTop li#pt-camtpl-nav {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                position: relative;
            ...
            #nav_chatTop li#pt-camtpl-nav select {
                background: #222;
                color: #eee;
            ...
            #pt-body { overflow: hidden; padding: 12px; flex: 1; min-height: 0; display: flex; flex-direction: column; }
            ...
            .pt-tabpane.active { display: flex; flex-direction: column; flex: 1; min-height: 0; overflow-y: auto; overflow-x: hidden; }
            .pt-section.pt-fill {
                flex: 1;
                min-height: 0;
                display: flex;
            ...
            .pt-section.pt-fill > .pt-list,
            .pt-section.pt-fill > textarea,
            .pt-section.pt-fill > .pt-tier-scroll {
                flex: 1;
                min-height: 0;
            ...
            .pt-tabpane.pt-pane-flex.active { overflow: hidden; }
            #pt-blockedyou-list {
                max-height: 300px;
                overflow-y: auto;
                background: #161616;
